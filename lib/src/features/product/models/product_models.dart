...
List<String> units = ['1 kg', '1 cái', '1 vỉ', '1 chai', '1 gói'];
...
final List<ProductItem> listProduct = List<ProductItem>.generate(
  200,
  (index) {
...
List<ProductItem> topDealProduct = listProduct.sublist(0, 20);

List<ProductItem> topSaleProduct = listProduct.sublist(40, 60);

List<ProductItem> cate1Product =
    listProduct.where((product) => product.category == "Trái cây").toList();
List<ProductItem> cate2Product =
    listProduct.where((product) => product.category == "Rau củ").toList();
List<ProductItem> cate3Product =
    listProduct.where((product) => product.category == "Thịt").toList();

List<ProductItem> cate4Product =
    listProduct.where((product) => product.category == "Hải sản").toList();

List<ProductItem> cate5Product =
    listProduct.where((product) => product.category == "Trứng").toList();

List<ProductItem> cate6Product =
    listProduct.where((product) => product.category == "Sữa").toList();

List<ProductItem> cate7Product =
    listProduct.where((product) => product.category == "Gia vị").toList();

List<ProductItem> cate8Product =
    listProduct.where((product) => product.category == "Hạt").toList();

List<ProductItem> cate9Product =
    listProduct.where((product) => product.category == "Bánh mỳ").toList();

List<ProductItem> cate10Product =
    listProduct.where((product) => product.category == "Đồ uống").toList();

List<ProductItem> cate11Product =
    listProduct.where((product) => product.category == "Ăn vặt").toList();

List<ProductItem> cate12Product =
    listProduct.where((product) => product.category == "Mỳ & gạo").toList();

List<ProductItem> isFavoritedProduct =
    listProduct.where((product) => product.isFavorite).toList();
